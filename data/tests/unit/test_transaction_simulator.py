...
from src.ingestion.transaction_simulator import TransactionSimulator, KAFKA_AVAILABLE
...
class TestTransactionSimulator:
    ...
    def test_simulate_stream(self, mock_kafka_producer):
        ...
        with patch('time.sleep'), patch('time.time') as mock_time:
            mock_time.side_effect = [0, 0.5, 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 5, 5.5, 6]  # More time values for simulation
    ...
    def test_fraud_amount_patterns(self):
        ...
        high_value = [t for t in fraud_transactions if t.get('fraud_amount_type') == 'high']
        low_value = [t for t in fraud_transactions if t.get('fraud_amount_type') == 'low']
        normal_value = [t for t in fraud_transactions if t.get('fraud_amount_type') == 'normal']
    ...
    def test_transaction_structure(self):
        ...
        expected_fields = [
            'Time', 'amount', 'Class',
            'transaction_id', 'timestamp', 'source'
...
def sample_transaction():
    ...
    return {
        ...
        'V10': 0.90, 'V11': -1.01, 'V12': 0.23,
        'V13': -0.45, 'V14': 0.67, 'V15': -0.89,
        'V16': 0.12, 'V17': -0.34, 'V18': 0.56,
        'V19': -0.78, 'V20': 0.90, 'V21': -1.01,
        'V22': 0.23, 'V23': -0.45, 'V24': 0.67,
        'V25': -0.89, 'V26': 0.12, 'V27': -0.34,
        'V28': 0.56,
...
def sample_fraud_transaction():
    ...
    return {
        ...
        'amount': 2500.00,
        'Class': 1,
        'V1': -5.67, 'V2': 2.34, 'V3': -3.45,
        'V4': -4.56, 'V5': 1.23, 'V6': -2.78,
        'V7': 3.12, 'V8': -1.89, 'V9': 0.45,
        'V10': -2.34, 'V11': 3.67, 'V12': -4.12,
        'V13': 1.78, 'V14': -5.23, 'V15': 2.45,
        'V16': -1.67, 'V17': 0.89, 'V18': -2.12,
        'V19': 1.34, 'V20': -0.78, 'V21': 2.56,
        'V22': -3.23, 'V23': 1.67, 'V24': -0.45,
        'V25': 2.89, 'V26': -1.12, 'V27': 0.34,
        'V28': -2.67,
