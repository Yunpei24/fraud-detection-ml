...
def test_database_settings():
    ...
    ), f"Expected port 5432, got {settings.database.port}"
    assert (
        settings.database.database == "fraud_db"
    ), f"Expected database fraud_db, got {settings.database.database}"
