...
class TestHourlyMonitoring:
    ...
    def test_call_api_drift_detection_success(self, mock_api_client, mock_api_response, test_settings):
    ...
    def test_call_api_drift_detection_error(self, mock_api_client, test_settings):
        ...
        mock_client_instance = MagicMock()
        mock_client_instance.detect_comprehensive_drift.return_value = {'error': 'API unavailable'}
        mock_api_client.return_value = mock_client_instance
    ...
    def test_check_thresholds_with_drift(self, mock_api_response_with_drift, test_settings):
    ...
    def test_trigger_alerts_no_drift(self, mock_alert_manager, mock_api_response, test_settings):
    ...
    @patch('src.pipelines.hourly_monitoring.AlertManager')
    def test_trigger_alerts_with_drift(self, mock_alert_manager, mock_api_response_with_drift, test_settings):
    ...
    def test_update_dashboards(self, mock_update_metrics, mock_api_response, test_settings):
    ...
    def test_run_hourly_monitoring_success(
        self, mock_alert_manager, mock_retraining_trigger, mock_api_call,
        mock_api_response, test_settings
    ):
        ...
        mock_retraining_instance.should_retrain.return_value = (False, "No drift detected")
    ...
    def test_run_hourly_monitoring_with_retraining(
        self, mock_alert_manager, mock_retraining_trigger, mock_api_call,
        mock_api_response_with_drift, test_settings
    ):
        ...
        mock_retraining_instance = MagicMock()
        mock_retraining_instance.should_retrain.return_value = (True, "High drift detected")
    ...
    @patch('src.pipelines.hourly_monitoring.call_api_drift_detection')
    def test_run_hourly_monitoring_exception_handling(self, mock_api_call, test_settings):
