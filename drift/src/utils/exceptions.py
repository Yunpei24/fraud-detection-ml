...
class InsufficientDataException(DriftDetectionException):
    ...
    def __init__(
        ...
        super().__init__(message=message, error_code="D001", details=details)
...
class DatabaseException(DriftDetectionException):
    ...
    def __init__(
        ...
        super().__init__(message=message, error_code="D002", details=details)
...
class AlertException(DriftDetectionException):
    ...
    def __init__(
        ...
        super().__init__(message=message, error_code="D003", details=details)
...
class RetrainingTriggerException(DriftDetectionException):
    ...
    def __init__(
        ...
        super().__init__(message=message, error_code="D004", details=details)
...
class MetricsComputationException(DriftDetectionException):
    ...
    def __init__(
        ...
        super().__init__(message=message, error_code="D005", details=details)
...
class StorageException(DriftDetectionException):
    ...
    def __init__(
        ...
        super().__init__(message=message, error_code="D006", details=details)
