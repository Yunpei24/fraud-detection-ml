...
class TestAirflowConfiguration:
    ...
    def test_constants_import(self):
        ...
        from airflow.config.constants import TABLE_NAMES, ENV_VARS, THRESHOLDS
    ...
    def test_airflow_settings_import(self):
        ...
        assert 'localhost' in settings.fraud_database_url or 'postgres' in settings.fraud_database_url
    ...
    def test_dag_imports(self):
        ...
        for dag_file in dag_files:
            ...
            with open(dag_path, 'r') as f:
                ...
                has_some_config = (
                    'TABLE_NAMES' in content or
                    'ENV_VARS' in content or
                    'THRESHOLDS' in content or
                    'SCHEDULES' in content or
                    'DOCKER_NETWORK' in content
                )
                
                # Either uses centralized config OR has some configuration
                assert has_centralized_config or has_some_config, f"{dag_file} has no configuration"
...
class TestDAGTrainingPipeline:
    ...
    def test_training_dag_file_exists(self):
        ...
        dag_path = os.path.join(os.path.dirname(__file__), '..', 'dags', '01_training_pipeline.py')
...
class TestDAGDriftMonitoring:
    ...
    def test_drift_dag_file_exists(self):
        ...
        dag_path = os.path.join(os.path.dirname(__file__), '..', 'dags', '02_drift_monitoring.py')
...
class TestDAGDataQuality:
    ...
    def test_data_quality_dag_file_exists(self):
        ...
        dag_path = os.path.join(os.path.dirname(__file__), '..', 'dags', '04_data_quality.py')
...
class TestDAGModelDeployment:
    ...
    def test_deployment_dag_file_exists(self):
        ...
        dag_path = os.path.join(os.path.dirname(__file__), '..', 'dags', '05_model_deployment_canary.py')
...
class TestDAGPerformanceTracking:
    ...
    def test_performance_dag_file_exists(self):
        ...
        dag_path = os.path.join(os.path.dirname(__file__), '..', 'dags', '06_model_performance_tracking.py')
