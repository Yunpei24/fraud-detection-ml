    ...
    def _load_config(self) -> None:
        ...
        try:
            ...
            if config_path.exists():
                ...
                logger.info(f"Loaded traffic routing config: {self.canary_percentage}% to canary")
            else:
                logger.info("No traffic routing config found, using Azure File Share champion path")
