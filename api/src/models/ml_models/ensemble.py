...
class EnsembleModel:
    ...
    def load_models(self) -> None:
        ...
        try:
            ...
            rf_path = os.path.join(
                self.models_path,
                settings.random_forest_model_name
            )
            ...
            iforest_path = os.path.join(
                self.models_path,
                settings.isolation_forest_model_name
            )
            ...
            shap_xgb_path = os.path.join(self.models_path, settings.shap_explainer_xgb_name)
            ...
            shap_rf_path = os.path.join(self.models_path, settings.shap_explainer_rf_name)
            ...
            shap_nn_path = os.path.join(self.models_path, settings.shap_explainer_nn_name)
            ...
            shap_iforest_path = os.path.join(self.models_path, settings.shap_explainer_iforest_name)
            if os.path.exists(shap_iforest_path):
                ...
                logger.warning(f"SHAP explainer (IForest) not found at {shap_iforest_path}")
    ...
    def explain_prediction(
        ...
        if explainer is None:
            logger.warning(f"SHAP explainer ({model_type}) not loaded, returning mock explanation")
    ...
    def health_check(self) -> bool:
        ...
        """
        return (
            self.xgboost_model is not None and
            self.random_forest_model is not None and
            self.nn_model is not None and
    ...
    def get_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "models": {
                ...
                "isolation_forest": "loaded" if self.isolation_forest_model else "not loaded"
            },
            "shap_explainers": {
