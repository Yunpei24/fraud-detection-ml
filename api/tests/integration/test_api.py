...
class TestPredictEndpoint:
    ...
    def test_predict_empty_features(self, client):
        ...
        data = {"transaction_id": "TEST-001", "features": []}
...
class TestHealthEndpoints:
    ...
    @pytest.mark.skip(
        reason="Detailed health check serialization issue with mocks - basic health check works"
    )
...
class TestMetricsEndpoint:
    ...
    def test_metrics_endpoint(self, client):
        ...
        assert "text/plain" in response.headers["content-type"] or "text/plain" in str(
