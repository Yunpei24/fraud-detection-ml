...
@pytest.fixture
def client():
    from src.api.dependencies import get_prediction_service, get_cache_service, get_database_service
    ...
    mock_cache_service.get_cached_prediction = AsyncMock(return_value={
        "transaction_id": "TEST-001",
        "prediction": 0,
        "confidence": 0.85,
        "fraud_score": 0.15,
...
class TestDriftEndpoints:
    ...
    def test_comprehensive_drift_detection_invalid_data(self, client, mock_drift_service):
    ...
    def test_sliding_window_analysis_missing_parameters(self, client, mock_drift_service):
