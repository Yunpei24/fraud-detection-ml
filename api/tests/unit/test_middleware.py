...
from src.api.middleware import RequestLoggingMiddleware, ErrorHandlingMiddleware, RateLimitingMiddleware
...
class TestRateLimitingMiddleware:
    ...
    def test_init_with_redis(self):
        ...
        middleware = RateLimitingMiddleware(MagicMock(), redis_client=mock_redis, requests_per_minute=100)
