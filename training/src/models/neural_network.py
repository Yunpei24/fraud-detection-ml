...
class NeuralNetworkModel:
    ...
    def __init__(
        ...
        logger.info(
            f"NeuralNetworkModel initialized (hidden_layers={hidden_layers}, tune_hyperparams={tune_hyperparams})"
        )
    ...
    def fit(
        ...
        self.is_fitted = True
        logger.info(
            f"Neural Network training completed in {self.model.n_iter_} iterations"
        )
