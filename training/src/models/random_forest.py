...
class RandomForestModel:
    ...
    def __init__(
        ...
        logger.info(f"RandomForestModel initialized (use_smote={use_smote}, tune_hyperparams={tune_hyperparams})")
    
    def fit(self, X: np.ndarray, y: np.ndarray, X_val: Optional[np.ndarray] = None, y_val: Optional[np.ndarray] = None) -> "RandomForestModel":
        """
